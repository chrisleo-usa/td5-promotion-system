...
feature 'admin disable coupon' do 
  ...
  scenario 'does not view button' do
    ...
    # Smpre que se tem within, a variável page é equivalente ao conteúdo do bloco da string. Como é uma div, tudo que estiver dentro dessa div, então será testado. 
